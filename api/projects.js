...
exports.default = [
    {
        ...
        skills: 'JavaScript, React, GraphQL, styled-components, LESS, CSS, NodeJS, Ant Design Component Library',
    ...
    },
    {
        ...
        description: '<p>I worked for Jam @ The Engine Group in Soho as a Mobile Front-end Developer building HTML5, CSS3, JavaScript/jQuery mobile and desktop websites. This contract was a great opportunity to develop my Mobile development skills working on the mobile version of the fabulous magazine http://fabulousmag.co.uk and several small Sky mobile promotional sites.</p>',
    ...
    },
    {
        ...
        role: 'Front-end Developer',
        company: 'Sapient',
        description: '<p>Whilst working for Sapient on this contract I was based client side at John Lewis, working in a team of Front-end Developers in an Agile Software Development Environment. I was responsible for creating well structured JavaScript/jQuery functionality and clean HTML/CSS template components keeping all code as re-usable and standards compliant as possible. We introduced HTML5 and CSS3 to the project using a progressive enhancement approach so as not to limit the site to just the latest browsers.</p>',
    ...
    },
    {
        ...
        role: 'Front-end Developer',
        company: 'Addison',
        description: '<p>Addison is a publishing-house/digital-agency based at London Bridge; I worked there for two months as a Front-end Developer. Whilst at Addison I completed three projects which required creating pixel perfect XHTML/CSS layouts. All three websites were for end of year financial reports that needed a lot of complex data displayed in tables and charts that both had to look good and comply with current web standards. www.annualreport.heineken.com</p>',
    ...
    },
    {
        ...
        role: 'Front-end Developer',
        company: 'Guardian',
        description: '<p>I worked for the Guardian as a Front-end Developer creating XHTML/CSS cross browser/platform compliant templates for www.thegreatplanthunt.org.</p>',
        skills: 'JavaScript/jQuery&#44; XHTML&#44; CSS3',
        links: [
    ...
    },
    {
        ...
        description: '<p>DOC (Department of Communities) Queensland Government Australia. I worked for the DOC on HTML/CSS table-less page design and development and the integration of front-end templates with their PHP based CMS.</p>',
    ...
    },
    {
        ...
        role: 'Developer',
        company: 'Ogilvy',
        description: '<p>I worked for Ogilvy as a Developer working across a broad range of brands such as BT, Yahoo, Amex and Unilever. I was responsible for the front-end build of websites adhering to strict brand-guidelines and W3C best practises.</p>',
        skills: 'Flash&#44; JavaScript/jQuery&#44; XHTML&#44; CSS',
